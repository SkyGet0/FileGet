...
**FileGet** - приложение для быстрого приема файлов на компьютер через веб-форму. Генерируется публичная ссылка туннеля, по которой можно загружать файлы с любого устройства в компьютер.

<img width="623" height="444" alt="изображение" src="https://github.com/user-attachments/assets/4dbbc2f9-8937-4555-ab77-78b32ff9534f" />
<img width="651" height="566" alt="изображение" src="https://github.com/user-attachments/assets/de3184d2-50d5-48cd-93ca-a061cff1e720" />
