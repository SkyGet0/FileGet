...
| **Bore** | False Positive | Проблемы с детектом антивируса |
| **Zrok** | Тестирование | **Планируемое решение** |

До этого я использовал туннель **localtunnel**, но пока не смог исправить ситуацию, когда страница постоянно автоматически обновляется после получения публичной ссылки.
На данный момент, я пока отложил работу с этим туннелем.
